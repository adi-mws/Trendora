...
export default function CustomerProfile() {
    ...
    return (
        <div className='CustomerProfile w-full font-secondary'>
            <div className="head p-5 flex ">
                <div className="coins-and-greet-section flex flex-col gap-5">
                    <p className="greet">Hi, Aditya</p>
                    <div className="doracoins text-xs w-160 gap-6 flex flex-col rounded-md bg-[linear-gradient(to_bottom,#F2F4FF,white)] p-5">
                        <p className='font-primary text-xl'>Your Dora Wallet</p>
                        <div className='flex gap-3 items-center'>
                            <img src="/icons/dora-coin.png" className='w-6' alt="dora-coins" />
                            <p className="amount-in-wallet text-xl">150 coins</p>
                        </div>
                ...
                <div className="profile-pic-section flex flex-col gap-2 text-xs items-center ms-5">
                    <div className="pfp">
                        <img src="/imgs/customer-profile.png" alt="profile" className='w-40 h-40 overflow-hidden bg-gray-100 rounded-full bg-cover profile-pic text-xs' />
                    </div>
            ...
            <div className="account-details text-sm grid grid-cols-2 w-full p-5 ">
                ...
                <div className='support-detail w-ful h-100'>
