        ...
        <header className='Header flex justify-evenly items-center h-16 w-full font-secondary text-sm'>
            ...
            <div className="NavItemsSection flex gap-2 justify-around items-center sm:w-200">
                <div className="nav-links hidden items-center gap-10 text-xs md:flex">
                    ...
                    <Link to="" className='md:flex hidden hover:underline'>Wishlist</Link>
        
                </div>

                <div className="search-wrapper text-xs flex items-center gap-2 bg-gray-100 w-65 lg:w-80 rounded-md py-3 px-5">
