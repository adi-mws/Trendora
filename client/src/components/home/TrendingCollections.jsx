...
export default function TrendingCollections() {
    return (
        <div className='TrendingCollections flex flex-col gap-8 items-center'>
            <p className='font-primary text-6xl font-semibold italic underline'>Trending Collections</p>
            <div className='TrendingCollections grid grid-cols-2 w-full'>
